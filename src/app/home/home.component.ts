...
export class HomeComponent implements OnInit, AfterViewInit {
  ...
  skills: Skill[] = [
    ...
    {name: 'Spring Boot', image: 'Spring_Boot.png'},
    ...
    {name: 'IBM Maximo', image: 'IBM_Maximo.png'},
    {name: 'UiPath', image: 'UiPath.png'},
    {name: 'ThreeJS', image: 'Three_JS.png'},
    {name: 'Pandas', image: 'Pandas.png'},
    {name: 'PyTorch', image: 'PyTorch.png'},
    {name: 'Google Bert', image: 'Bert.svg'},
    {name: 'Hugging Face', image: 'Hugging_Face.svg'},
    {name: 'Jet Brains', image: 'Jet_Brains.png'},
